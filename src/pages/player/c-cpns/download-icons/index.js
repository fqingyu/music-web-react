    ...
    return (
        <DownloadIconsWrapper>
            ...
            <ul className="button-list sprite_icon4">
                <li>
                    <a href="https://itunes.apple.com/cn/app/id590338362" class="ios sprite_icon4" hidefocus="true" target="_blank">iPhone</a>
                </li>
                <li>
                    <a href="https://music.163.com/api/pc/download/latest" class="pc sprite_icon4" hidefocus="true" target="_blank">PC</a>
                </li>
                <li>
                    <a href="https://music.163.com/api/android/download/latest2" class="aos sprite_icon4" hidefocus="true" target="_blank">Android</a>
                </li>
            </ul>
